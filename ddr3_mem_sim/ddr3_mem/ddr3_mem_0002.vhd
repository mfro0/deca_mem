...
end entity ddr3_mem_0002;

architecture rtl of ddr3_mem_0002 is
	component ddr3_mem_pll0 is
		port (
			...
			pll_capture0_clk   : out std_logic;                                       -- pll_capture0_clk
			pll_capture1_clk   : out std_logic;                                       -- pll_capture1_clk
			phasecounterselect : in  std_logic_vector(2 downto 0) := (others => 'X'); -- phasecounterselect
			phasestep          : in  std_logic                    := 'X';             -- phasestep
			phaseupdown        : in  std_logic                    := 'X';             -- phaseupdown
			scanclk            : in  std_logic                    := 'X';             -- scanclk
			phasedone          : out std_logic                                        -- phasedone
		);
	end component ddr3_mem_pll0;

	component ddr3_mem_p0 is
		port (
			global_reset_n              : in    std_logic                     := 'X';             -- reset_n
			...
			pd_up                       : out   std_logic;                                        -- pd_up
			pd_down                     : out   std_logic;                                        -- pd_down
	...
	end component ddr3_mem_s0;

	component ddr3_mem_c0 is
		port (
			afi_reset_n         : in  std_logic                     := 'X';             -- reset_n
			afi_clk             : in  std_logic                     := 'X';             -- clk
			afi_half_clk        : in  std_logic                     := 'X';             -- clk
	...
	signal s0_pll_reconfig_scanclk            : std_logic;                     -- s0:scanclk -> pll0:scanclk
	signal s0_pll_reconfig_phaseupdown        : std_logic;                     -- s0:phaseupdown -> pll0:phaseupdown
	signal s0_pll_reconfig_phasecounterselect : std_logic_vector(2 downto 0);  -- s0:phasecounterselect -> pll0:phasecounterselect
	signal s0_pll_reconfig_phasestep          : std_logic;                     -- s0:phasestep -> pll0:phasestep
	signal pll0_pll_reconfig_phasedone        : std_logic;                     -- pll0:phasedone -> s0:phasedone
	signal s0_phase_detector_pd_ack           : std_logic;                     -- s0:pd_ack -> p0:pd_ack
	signal s0_phase_detector_pd_reset_n       : std_logic;                     -- s0:pd_reset_n -> p0:pd_reset_n
	...
	signal pll0_pll_sharing_pll_capture1_clk  : std_logic;                     -- pll0:pll_capture1_clk -> [pll_capture1_clk, p0:pll_capture1_clk]
	signal pll0_pll_sharing_pll_capture0_clk  : std_logic;                     -- pll0:pll_capture0_clk -> [pll_capture0_clk, p0:pll_capture0_clk]
...
begin
	...
	pll_capture1_clk <= pll0_pll_sharing_pll_capture1_clk;

	pll_capture0_clk <= pll0_pll_sharing_pll_capture0_clk;

	pll_mem_clk <= pll0_pll_sharing_pll_mem_clk;

	pll_locked <= pll0_pll_sharing_pll_locked;

end architecture rtl; -- of ddr3_mem_0002
