...
set ::GLOBAL_ddr3_mem_p0_corename "ddr3_mem_p0"
set ::GLOBAL_ddr3_mem_p0_io_standard "SSTL-15"
set ::GLOBAL_ddr3_mem_p0_io_interface_type "HPAD"
set ::GLOBAL_ddr3_mem_p0_io_standard_differential "1.5-V SSTL"
set ::GLOBAL_ddr3_mem_p0_io_standard_cmos "1.5V"
set ::GLOBAL_ddr3_mem_p0_number_of_dqs_groups 1
set ::GLOBAL_ddr3_mem_p0_dqs_group_size 8
set ::GLOBAL_ddr3_mem_p0_number_of_ck_pins 1
set ::GLOBAL_ddr3_mem_p0_number_of_dm_pins 1
set ::GLOBAL_ddr3_mem_p0_dqs_delay_chain_length 2
set ::GLOBAL_ddr3_mem_p0_uniphy_temp_ver_code 318331200
# PLL Parameters
...
set ::GLOBAL_ddr3_mem_p0_pll_mult(0) 6
set ::GLOBAL_ddr3_mem_p0_pll_div(0) 5
set ::GLOBAL_ddr3_mem_p0_pll_phase(0) 0.0
set ::GLOBAL_ddr3_mem_p0_pll_mult(PLL_AFI_CLK) 6
set ::GLOBAL_ddr3_mem_p0_pll_div(PLL_AFI_CLK) 5
set ::GLOBAL_ddr3_mem_p0_pll_phase(PLL_AFI_CLK) 0.0
set ::GLOBAL_ddr3_mem_p0_pll_mult(1) 12
set ::GLOBAL_ddr3_mem_p0_pll_div(1) 5
set ::GLOBAL_ddr3_mem_p0_pll_phase(1) 0.0
set ::GLOBAL_ddr3_mem_p0_pll_mult(PLL_MEM_CLK) 12
set ::GLOBAL_ddr3_mem_p0_pll_div(PLL_MEM_CLK) 5
set ::GLOBAL_ddr3_mem_p0_pll_phase(PLL_MEM_CLK) 0.0
set ::GLOBAL_ddr3_mem_p0_pll_mult(2) 12
set ::GLOBAL_ddr3_mem_p0_pll_div(2) 5
set ::GLOBAL_ddr3_mem_p0_pll_phase(2) 270.0
set ::GLOBAL_ddr3_mem_p0_pll_mult(PLL_WRITE_CLK) 12
set ::GLOBAL_ddr3_mem_p0_pll_div(PLL_WRITE_CLK) 5
set ::GLOBAL_ddr3_mem_p0_pll_phase(PLL_WRITE_CLK) 270.0
set ::GLOBAL_ddr3_mem_p0_pll_mult(3) 12
set ::GLOBAL_ddr3_mem_p0_pll_div(3) 5
set ::GLOBAL_ddr3_mem_p0_pll_phase(3) 0.0
set ::GLOBAL_ddr3_mem_p0_pll_mult(PLL_ADDR_CMD_CLK) 12
set ::GLOBAL_ddr3_mem_p0_pll_div(PLL_ADDR_CMD_CLK) 5
set ::GLOBAL_ddr3_mem_p0_pll_phase(PLL_ADDR_CMD_CLK) 0.0
set ::GLOBAL_ddr3_mem_p0_pll_mult(4) 12
set ::GLOBAL_ddr3_mem_p0_pll_div(4) 5
set ::GLOBAL_ddr3_mem_p0_pll_phase(4) 270.0
set ::GLOBAL_ddr3_mem_p0_pll_mult(PLL_AFI_HALF_CLK) 12
set ::GLOBAL_ddr3_mem_p0_pll_div(PLL_AFI_HALF_CLK) 5
set ::GLOBAL_ddr3_mem_p0_pll_phase(PLL_AFI_HALF_CLK) 270.0

set ::GLOBAL_ddr3_mem_p0_leveling_capture_phase 90.0
