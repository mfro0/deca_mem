// ddr3_mem_s0_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module ddr3_mem_s0_mm_interconnect_0 (
	...
	ddr3_mem_s0_mm_interconnect_0_router router (
	...
	ddr3_mem_s0_mm_interconnect_0_router_001 router_001 (
	...
	ddr3_mem_s0_mm_interconnect_0_router_001 router_002 (
	...
	ddr3_mem_s0_mm_interconnect_0_router_001 router_003 (
	...
	ddr3_mem_s0_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (avl_clk_out_clk_clk),                                          //       clk.clk
		.reset              (sequencer_phy_mgr_inst_avl_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ddr3_mem_s0_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (avl_clk_out_clk_clk),                                          //       clk.clk
		.reset               (sequencer_phy_mgr_inst_avl_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ddr3_mem_s0_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (avl_clk_out_clk_clk),                                          //       clk.clk
		.reset               (sequencer_phy_mgr_inst_avl_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ddr3_mem_s0_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (avl_clk_out_clk_clk),                                          //       clk.clk
		.reset               (sequencer_phy_mgr_inst_avl_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ddr3_mem_s0_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (avl_clk_out_clk_clk),                                          //       clk.clk
		.reset              (sequencer_phy_mgr_inst_avl_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ddr3_mem_s0_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (avl_clk_out_clk_clk),                                          //       clk.clk
		.reset              (sequencer_phy_mgr_inst_avl_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ddr3_mem_s0_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (avl_clk_out_clk_clk),                                          //       clk.clk
		.reset              (sequencer_phy_mgr_inst_avl_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ddr3_mem_s0_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (avl_clk_out_clk_clk),                                          //       clk.clk
		.reset               (sequencer_phy_mgr_inst_avl_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ddr3_mem_s0_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
