...
lappend arg_list "--component-param=SEQ_ROM=ddr3_mem_s0_sequencer_mem.hex"
lappend arg_list "--component-param=RAM_BLOCK_TYPE=AUTO"
lappend arg_list "--component-param=AC_ROM_INIT_FILE_NAME=ddr3_mem_s0_AC_ROM.hex"
lappend arg_list "--component-param=INST_ROM_INIT_FILE_NAME=ddr3_mem_s0_inst_ROM.hex"
...
lappend arg_list "--output-name=ddr3_mem_s0"
...
catch { eval [concat [list exec "/opt/intelFPGA_lite/17.0/quartus//sopc_builder/bin/ip-generate" --component-name=qsys_sequencer_110] $arg_list] } temp
puts $temp
